import {
  ...
  require_uniqBy
} from "./chunk-F37UHEEN.js";
import {
  H,
  X as X2
} from "./chunk-ZWNL5UHC.js";
import {
  At,
  Bi,
  Ji,
  ...
  useTransition,
  w
} from "./chunk-NACDUMNC.js";
import "./chunk-ZRYTYW4C.js";
import "./chunk-CZUAWVZQ.js";
...
var T = function(t2) {
  var n2 = t2.datum, e3 = t2.x, a2 = t2.y, r = t2.note, s = Vt(), l = tt(), u2 = l.animate, c2 = l.config, k3 = useSpring({ x: e3, y: a2, config: c2, immediate: !u2 });
...
var D = function(t2) {
  var n2 = t2.x, i2 = t2.y, o2 = t2.size, e3 = Vt(), a2 = tt(), r = a2.animate, s = a2.config, l = useSpring({ x: n2, y: i2, radius: o2 / 2, config: s, immediate: !r });
...
var I = function(t2) {
  var n2 = t2.x, i2 = t2.y, o2 = t2.size, e3 = void 0 === o2 ? k2.dotSize : o2, a2 = Vt(), r = tt(), s = r.animate, l = r.config, u2 = useSpring({ x: n2, y: i2, radius: e3 / 2, config: l, immediate: !s });
...
var L = function(t2) {
  var n2 = t2.x, i2 = t2.y, o2 = t2.width, e3 = t2.height, a2 = t2.borderRadius, r = void 0 === a2 ? 6 : a2, s = Vt(), l = tt(), u2 = l.animate, c2 = l.config, k3 = useSpring({ x: n2 - o2 / 2, y: i2 - e3 / 2, width: o2, height: e3, config: c2, immediate: !u2 });
...
var Z = function(e3) {
  ...
  return (0, import_jsx_runtime2.jsxs)(animated.g, { transform: f, children: [(0, import_jsx_runtime2.jsx)(animated.rect, { width: to(m2, function(e4) {
    ...
    return Math.max(e4, 0);
  }), rx: p2, ry: p2, fill: null != (a2 = t2.fill) ? a2 : o2, strokeWidth: x2, stroke: l, focusable: I3, tabIndex: I3 ? 0 : void 0, "aria-label": T3 ? T3(t2) : void 0, "aria-labelledby": R3 ? R3(t2) : void 0, "aria-describedby": H3 ? H3(t2) : void 0, onMouseEnter: k3 ? N2 : void 0, onMouseMove: k3 ? q3 : void 0, onMouseLeave: k3 ? J3 : void 0, onClick: k3 ? j2 : void 0, onFocus: k3 && I3 ? Q2 : void 0, onBlur: k3 && I3 ? Z2 : void 0 }), S2 && (0, import_jsx_runtime2.jsx)(animated.text, { x: g2, y: v2, textAnchor: "middle", dominantBaseline: "central", fillOpacity: h, style: z2({}, F.labels.text, { pointerEvents: "none", fill: s }), children: y })] });
};
var $ = ["color", "label"];
...
var Ve = function(e3) {
  ...
  (0, import_react2.useEffect)(function() {
    ...
    Be2.current && a3 && (Be2.current.width = Ee * We3, Be2.current.height = Fe * We3, a3.scale(We3, We3), a3.fillStyle = Ie.background, a3.fillRect(0, 0, Ee, Fe), a3.translate(Re.left, Re.top), K2.forEach(function(e5) {
      ...
      }) : "annotations" === e5 ? J(a3, { annotations: Ze, theme: Ie }) : "function" == typeof e5 && e5(a3, $e);
    }), a3.save());
  }, [P2, F, I3, B3, De, oe2, ue2, Ze, D2, G, qe, Ae, ze, A, j2, v2, g2, Pe, He, $e, K2, f, Ne, Re.left, Re.top, Fe, Ee, We3, J3, Oe, Ge, m2, Ke, Ie, s]);
