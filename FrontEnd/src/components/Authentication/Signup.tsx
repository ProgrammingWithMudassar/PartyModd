                    ...
                    <form className='mt-[30px]'>
                        <div className='w-[27.608069164265128vw] flex xsm:flex-col sm:flex-col xsm:w-full sm:w-full gap-[1.2680115273775217vw]'>
                            <div className='flex-1 flex flex-col'>
                                ...
                                <input className=' h-[50px] rounded-[10px] border-[1px] border-[#473a3a]' style={{padding:"0 10px"}} />
                            </div>
                            <div className='flex-1 flex flex-col'>
                        ...
                        <div className='mt-[20px]'>
                            ...
                            <input className='w-[27.608069164265128vw] sm:flex-col xsm:w-full sm:w-full h-[50px] block rounded-[10px] border-[1px] border-[#473a3a]' style={{padding:"0 10px"}}/>
