                        ...
                        <li className='relative flex items-center'>
                            ...
                            {openContextMenu &&
                                <div style={{ boxShadow: "1px 1px 8px #00000030" }} className='transition-all w-[181px] h-[170px] bg-white absolute z-[1] flex flex-col justify-around py-[20px] top-full right-[-30%]'>
                                    ...
                                    <motion.p whileHover={{ color: "#FB4A04" }} className='text-[#473a3a] cursor-pointer font-[400] text-[clamp(12px,0.9221902017291066vw,16px)] leading-[23px] text-center'>Explore Community Vibe</motion.p>
                                </div>
                            }
                        </li>
                    </ul>
